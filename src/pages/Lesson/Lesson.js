...
const Lesson = () => {
  return (
    <>
      <div className="w-80 vh-100 d-flex justify-content-end align-items-end lessonmain">
        <div className=" d-flex  col-9  ">
          ...
          <div className=" col-5 card  m-3 shadowblack">
            <img src="./imgs/l01.jpg" className="card-img-top" alt="..." />
          ...
          <div className=" col-5 card  m-3 shadowblack">
            <img src="./imgs/l02.jpg" className="card-img-top" alt="..." />
            <div className="card-body ">
              <h5 className="card-title text-center fs-4 fw-bold">
                HRC 舞蹈工作室{' '}
              </h5>
