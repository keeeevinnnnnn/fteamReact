...
const Lesson = () => {
  return (
    <>
      <div className="row">
        <div className=" col-1 text-center center p-6 ">
        ...
        <div className=" col-4 card p-6 m-5 shadowblack">
          <img src="./images/10001.jpg" className="card-img-top" alt="..." />
          <div className="card-body ">
            <h5 className="card-title text-center fs-4 fw-bold">
              HRC 舞蹈工作室{' '}
            </h5>
            <h6 className="card-title text-center fs-5 fw-bold"> 【忠孝館】</h6>
        ...
        <div className=" col-4 card p-6 m-5 shadowblack">
          <img src="./images/10002.jpg" className="card-img-top" alt="..." />
          <div className="card-body ">
            <h5 className="card-title text-center fs-4 fw-bold">
              HRC 舞蹈工作室{' '}
            </h5>
