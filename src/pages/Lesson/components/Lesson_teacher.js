  ...
  return (
    <>
      <section className="  w-100 h-100 d-flex flex-wrap">
        <div className="col-sm-6 col-12 cooler_teacher_card pe-3 mb-4  ">
          <div className="h-55 ">
            <div className="cooler_teacher_log h-100 d-flex">
              <div className="cooler_teacher_card_head w-55 h-90">
                erfdsfsdfdsfds
              </div>
              <div className=" w-45  ">
                <h4 className="cooler_teacher_card_teachername w-100 h-100">Nike</h4>
              </div>
            </div>
          </div>
