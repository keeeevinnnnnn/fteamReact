      ...
      <div className=" col-sm-12 col-12 cooler_lesson_card   h-20 d-flex flex-wrap border-bottom">
        <div className=" col-sm-6 col-12">
          <div className="cooler_lesson_card_title_collect d-flex">
            <h5 className="w-90">Key Glock - Ambition For Cash</h5>
        ...
        <div className=" cooler_lesson_card_quota_number col-sm-1 col-12 d-flex  align-items-end justify-content-around">
        ...
        <div className="  col-sm-5 col-12 d-flex ">
          <div className="cooler_lesson_card_category_price w-50  d-flex justify-content-end align-items-end flex-column justify-content-between">
            <p className="cooler_lesson_card_category cooler_gray">Popping</p>
            <p className="cooler_gray">3000</p>
          </div>
          <div className="w-50 h-100 d-flex align-items-center justify-content-center  m-auto">
            <div className=" ms-4 col-sm-6 col-4 h-50 cooler_lesson_card_btn  d-flex align-items-center justify-content-center">
